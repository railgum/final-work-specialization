...
b) определять животное в правильный класс
c) увидеть список команд, которое выполняет животное
d) обучить животное новым командам
e) Реализовать навигацию по меню
